...
<body class="bg-gray-100 py-10">
    <div class="min-h-screen flex items-center justify-center">
        <div class="w-1/2 p-6 bg-white rounded-lg shadow-lg">
            ...
            <form action='{{ route("monitoring.update", $monitoring->id) }}' method='GET'>
                ...
                <x-form.form-select id="kondisi_bts" label="Kondisi BTS" name="kondisi_bts" :options="['Baik' => 'Baik', 'Buruk' => 'Buruk']" />
